...
├── Fake-News-Detection-Enhanced.ipynb     # Main Jupyter notebook
├── data/
...
- Dataset sourced from combined legitimate and fake news collections
- Built using Google Colab for collaborative development
- Implements best practices in NLP and machine learning workflows

## 📞 Contact & Support

For questions or improvements, please refer to the project repository or reach out to the author.
